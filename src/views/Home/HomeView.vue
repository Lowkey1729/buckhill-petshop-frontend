...
<template>
  ...
  <section class="tw-relative tw-my-6">
    ...
    <div class="tw-w-full tw-h-96 tw-bg-cover tw-bg-gray-300 tw-rounded-lg tw-overflow-hidden tw-relative">
      <img src="/images/hero-image.png" alt="Image description" class="absolute inset-0 object-cover w-full h-full opacity-75">

      <div class="tw-absolute tw-inset-0 tw-flex tw-flex-col tw-gap-3 tw-ml-24 tw-mt-24 tw-text-white">
        <div class="m-1 tw-w-[35%]">
          <p class=" tw-bg-black tw-opacity-40 tw-text-5xl tw-p-5">Up to 30% sale</p>
        </div>
        <div class="m-1 tw-w-[50%]">
          <p class=" tw-bg-black tw-opacity-40  tw-w-1/2  tw-text-xl tw-p-2">On select dog food and toys</p>
        </div>
      </div>
